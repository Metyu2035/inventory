        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body" id="card-edu">
                    ...
                    <p style="text-align: center; font-size: 14px;">Silahkan login untuk mengakses !</p>
                    ...
                    <form action="<?= base_url('home/login') ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3"></div>
                            <div class="col-5">
                                <button id="btn-edu" type="submit" class="btn btn-block">Login</button>
                            </div>
                        </div>
                    </form>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <p id="lupa-edu">Lupa Password ? <a href="<?= base_url('forgot') ?>"> Klik Disini !</a></p>
                        </div>
                    </div>
                </div>
                <!-- Card Login End -->
