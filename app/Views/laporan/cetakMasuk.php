...
<head>
    ...
    <title>Laporan Barang Masuk <?= dateindo($tanggalAwal) ?> - <?= dateindo($tanggalAkhir) ?></title>
...
<body onload="print()">
    <div class="eduhoster">
        ...
        <div class="judul-cetak">
            <h3 style="font-size: 18px;"><u> LAPORAN BARANG MASUK </u></h3>
        ...
        <div class="isi">
            <table class="table table-bordered border-dark">
                <tr style="font-size: smaller; color: white; background-color: #06283d;">
                    <th>No</th>
                    <th>Tanggal Masuk</th>
                    <th>No Order</th>
                    <th>Barang</th>
                ...
                <!-- <tr border="1" style="font-size: small;">
                    <td colspan="6" style="font-weight: bold; text-align: center;">Total Barang Masuk</td>
    ...
    <footer>
        <div class="tanda-tangan">
            <div class="isittd">
                <p class="text-center" style="font-weight: bold;">Tanda Tangan</p>
                <br>
                <br>
                <p class="text-center">.......................................................</p>
                <p class="text-center">Tangerang, <?= date('d F Y') ?></p>
            </div>
        </div>
    </footer>
