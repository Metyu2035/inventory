        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body" id="card-edu">
                    ...
                    <!-- Judul Login -->
                    <p style="text-align: center; font-size: 14px;">Silahkan masukan username anda !</p>

                    <!-- Form Login -->
                    <form action="<?= base_url('home/reset') ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3"></div>
                            <div class="col-5">
                                <button id="btn-edu" type="submit" class="btn btn-block">Reset</button>
                            </div>
                        </div>
                    </form>
                    <hr>
                    <div class="row">
                        <div class="col-12">
                            <p id="lupa-edu">Login ? <a href="<?= base_url('/') ?>"> Klik Disini !</a></p>
                        </div>
                    </div>
                </div>
                <!-- Card Login End -->
